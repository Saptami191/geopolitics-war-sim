...
export default function CyberWidget() {
  ...
  return (
    <div 
      className="bg-[#050a05]/90 border border-[#00ff41]/30 p-2 flex flex-col font-mono text-xs cursor-pointer hover:bg-[#00ff41]/10 transition-colors backdrop-blur mt-2"
      onClick={() => {
        audio.sfxKeyClick();
